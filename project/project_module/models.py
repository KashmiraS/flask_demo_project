...
class project_wapper():
    def __init__(self, project_name, project_description, project_starting_date, project_releasing,
                 customer_name, customer_contact, customer_mail, customer_company_name, customer_site):
        self.project_name = project_name
        self.project_description = project_description
        self.project_starting_date = project_starting_date
        self.project_releasing = project_releasing
